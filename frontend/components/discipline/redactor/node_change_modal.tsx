...
const NodeChangeModal: React.FC<NodeChangeModalProps> = ({ selectedNode, saveSelectedNode, closeModal }) => {
    ...
    return (
        <div className='fixed z-10 overflow-y-auto w-96 h-[95%] bg-slate-400 p-4 rounded-lg shadow-lg top-0 right-[1%] mt-[1.25%]'>
            <div className='flex justify-between items-center'>
                <h1 className='text-2xl font-bold text-white'>Change Node</h1>
